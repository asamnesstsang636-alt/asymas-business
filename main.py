...
# CSS pour enlever les marges + styliser le champ mot de passe
st.markdown("""
<style>
...
""", unsafe_allow_html=True)  # <- CRITIQUE : sans ça Streamlit affiche le code

# Champ mot de passe dans le rectangle de la base
