...
# === ACCUEIL AVEC BOUTONS CLIQUABLES ===
def show_home():
    st.markdown("""
    ...
    # Boutons cliquables sur le cercle
    modules = [
        ("🏪\nCommerce", "Commerce", "0px", "50%", "translateX(-50%)"),
        ("🚚\nAuto", "Auto", "45px", "auto", "auto"),
        ("🧾\nFactures", "Factures", "auto", "auto", "auto"),
        ("🏠\nImmo", "Immo", "auto", "50%", "translateX(-50%)"),
        ("📦\nStock", "Stock", "auto", "auto", "auto"),
        ("📊\nCompta", "Compta", "45px", "auto", "auto")
    ]

    positions = [
        {"top": "0px", "left": "50%", "right": "auto", "bottom": "auto", "transform": "translateX(-50%)"},
        {"top": "45px", "left": "auto", "right": "35px", "bottom": "auto", "transform": "none"},
        {"top": "auto", "left": "auto", "right": "35px", "bottom": "45px", "transform": "none"},
        {"top": "auto", "left": "50%", "right": "auto", "bottom": "0px", "transform": "translateX(-50%)"},
        {"top": "auto", "left": "35px", "right": "auto", "bottom": "45px", "transform": "none"},
        {"top": "45px", "left": "35px", "right": "auto", "bottom": "auto", "transform": "none"}
    ]

    for i, (label, module_name) in enumerate([("🏪\nCommerce", "Commerce"), ("🚚\nAuto", "Auto"), ("🧾\nFactures", "Factures"),
                                              ("🏠\nImmo", "Immo"), ("📦\nStock", "Stock"), ("📊\nCompta", "Compta")]):
        pos = positions[i]
        st.markdown(f'<div style="position:absolute;top:{pos["top"]};left:{pos["left"]};right:{pos["right"]};bottom:{pos["bottom"]};transform:{pos["transform"]};z-index:10;">', unsafe_allow_html=True)
        if st.button(label, key=f"btn_{module_name}"):
            st.session_state.selected_module = module_name
        st.markdown('</div>', unsafe_allow_html=True)

    # Bouton déconnexion sur l'accueil
...
if not st.session_state.logged_in:
    ...
    if st.session_state.selected_module:
        ...
        # Tes modules ici - un seul ouvert à la fois
