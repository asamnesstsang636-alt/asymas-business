...
st.markdown("""
<div style="position:relative; width:100vw; height:90vh; background:radial-gradient(circle at center, rgba(255,215,0,0.7) 0%, rgba(10,10,10,1) 60%); overflow:hidden; margin:0;">
