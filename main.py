...
<div style="position:relative;width:100vw;height:100vh;background:radial-gradient(ellipse at center 55%, rgba(255,215,0,0.6) 0%, rgba(15,15,15,1) 80%);overflow:hidden;">
    ...
    <!-- Base téléphone/tablette ASYMAS -->
    ...
    <div style="position:absolute;top:48%;left:50%;transform:translate(-50%,-50%);width:420px;height:420px;">
        ...
        <!-- Modules ASYMAS positionnés -->
        <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:360px;height:360px;">
            <!-- E-Commerce -->
            <div style="position:absolute;top:5px;left:50%;transform:translateX(-50%);background:#fff;border:3px solid #FFD700;border-radius:50%;width:55px;height:55px;display:flex;align-items:center;justify-content:center;font-size:26px;box-shadow:0 0 30px rgba(255,215,0,0.6);" title="E-Commerce">🏪</div>
            <!-- Logistique -->
            <div style="position:absolute;top:50px;right:40px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:55px;height:55px;display:flex;align-items:center;justify-content:center;font-size:26px;box-shadow:0 0 30px rgba(255,215,0,0.6);" title="Logistique">🚚</div>
            <!-- Marketing -->
            <div style="position:absolute;bottom:50px;right:40px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:55px;height:55px;display:flex;align-items:center;justify-content:center;font-size:26px;box-shadow:0 0 30px rgba(255,215,0,0.6);" title="Marketing">📢</div>
            <!-- CRM -->
            <div style="position:absolute;bottom:-5px;left:50%;transform:translateX(-50%);background:#fff;border:3px solid #FFD700;border-radius:50%;width:55px;height:55px;display:flex;align-items:center;justify-content:center;font-size:26px;box-shadow:0 0 30px rgba(255,215,0,0.6);" title="CRM">@</div>
            <!-- Facturation -->
            <div style="position:absolute;bottom:50px;left:40px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:55px;height:55px;display:flex;align-items:center;justify-content:center;font-size:26px;box-shadow:0 0 30px rgba(255,215,0,0.6);" title="Facturation">🧾</div>
            <!-- Analytics -->
            <div style="position:absolute;top:50px;left:40px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:55px;height:55px;display:flex;align-items:center;justify-content:center;font-size:26px;box-shadow:0 0 30px rgba(255,215,0,0.6);" title="Analytics">📊</div>
        </div>
    </div>
</div>
<style>
