...
<style>@keyframes pulse{0%,100%{transform:translate(-50%,-50%) scale(1);box-shadow:0 0 90px #FFD700,0 0 180px #FFA500;}50%{transform:translate(-50%,-50%) scale(1.15);box-shadow:0 0 110px #FFD700,0 0 220px #FFA500;}}@keyframes rotate{from{transform:translate(-50%,-50%) rotate(0deg);}to{transform:translate(-50%,-50%) rotate(360deg);}}</style>
