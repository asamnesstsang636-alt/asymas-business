...
def show_home():
    ...
    # Les 6 boutons pile sur le grand cercle comme ta photo
    st.markdown('<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(90deg) translate(190px) rotate(-90deg);z-index:10;">', unsafe_allow_html=True)
    if st.button("🏪\nCommerce", key="btn_commerce"): st.session_state.selected_module = "Commerce"
    st.markdown('</div>', unsafe_allow_html=True)

    st.markdown('<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(30deg) translate(190px) rotate(-30deg);z-index:10;">', unsafe_allow_html=True)
    ...
    st.markdown('<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-150deg) translate(190px) rotate(150deg);z-index:10;">', unsafe_allow_html=True)
...
if not st.session_state.logged_in:
    ...
    if st.session_state.selected_module:
        ...
        if st.button("← Retour"): st.session_state.selected_module = None
