...
<div style="position:relative;width:100vw;height:100vh;background:radial-gradient(ellipse at center 55%, rgba(255,215,0,0.7) 0%, rgba(15,15,15,1) 85%);overflow:hidden;">
    ...
    <div style="position:absolute;top:45%;left:50%;transform:translate(-50%,-50%);width:450px;height:450px;">
        ...
        <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:380px;height:380px;">
            <div style="position:absolute;top:0px;left:50%;transform:translateX(-50%);background:#fff;border:3px solid #FFD700;border-radius:50%;width:60px;height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:24px;box-shadow:0 0 20px #FFD700;cursor:pointer;" onclick="window.location.href='#Commerce'"><div>🏪</div><div style="font-size:8px;color:#000;font-weight:bold;">Commerce</div></div>
            <div style="position:absolute;top:45px;right:35px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:60px;height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:24px;box-shadow:0 0 20px #FFD700;cursor:pointer;" onclick="window.location.href='#Auto'"><div>🚚</div><div style="font-size:8px;color:#000;font-weight:bold;">Auto</div></div>
            <div style="position:absolute;bottom:45px;right:35px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:60px;height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:24px;box-shadow:0 0 20px #FFD700;cursor:pointer;" onclick="window.location.href='#Factures'"><div>🧾</div><div style="font-size:8px;color:#000;font-weight:bold;">Factures</div></div>
            <div style="position:absolute;bottom:0px;left:50%;transform:translateX(-50%);background:#fff;border:3px solid #FFD700;border-radius:50%;width:60px;height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:24px;box-shadow:0 0 20px #FFD700;cursor:pointer;" onclick="window.location.href='#Immo'"><div>🏠</div><div style="font-size:8px;color:#000;font-weight:bold;">Immo</div></div>
            <div style="position:absolute;bottom:45px;left:35px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:60px;height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:24px;box-shadow:0 0 20px #FFD700;cursor:pointer;" onclick="window.location.href='#Stock'"><div>📦</div><div style="font-size:8px;color:#000;font-weight:bold;">Stock</div></div>
            <div style="position:absolute;top:45px;left:35px;background:#fff;border:3px solid #FFD700;border-radius:50%;width:60px;height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:24px;box-shadow:0 0 20px #FFD700;cursor:pointer;" onclick="window.location.href='#Compta'"><div>📊</div><div style="font-size:8px;color:#000;font-weight:bold;">Compta</div></div>
        </div>
    </div>
</div>
<style>@keyframes pulseRing{{0%,100%{{transform:translate(-50%,-50%) scale(1);opacity:0.7;}}50%{{transform:translate(-50%,-50%) scale(1.12);opacity:1;}}}}
