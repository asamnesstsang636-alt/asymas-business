...
# CSS pour cacher les marges + styliser le champ mot de passe
st.markdown("""
<style>
...
# Champ mot de passe positionné dans le rectangle de la base
...
if pwd:
    if pwd == "asymas2025":  # change ce mot de passe
        ...
        # Ici tu peux afficher le dashboard ASYMAS
    else:
