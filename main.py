...
<div style="position:relative;width:100vw;height:100vh;background:radial-gradient(ellipse at center 55%, rgba(255,215,0,0.6) 0%, rgba(15,15,15,1) 80%);overflow:hidden;">
    ...
    <div style="position:absolute;top:48%;left:50%;transform:translate(-50%,-50%);width:420px;height:420px;">
        ...
        <!-- CHAMP MOT DE PASSE DANS LE PETIT CERCLE BLANC -->
        <input type="password" id="pwd" placeholder="Mot de passe" 
        style="position:absolute;bottom:36%;left:50%;transform:translateX(-50%);width:120px;height:32px;background:#fff;border:2px solid #FFD700;border-radius:20px;text-align:center;color:#000;font-size:12px;outline:none;">
    </div>
</div>
